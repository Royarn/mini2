        ...
        target.load = function(parms){
            ...
            $.ajax({
                ...
                success : function(data, textStatus, jqXHR) {
                    ...
                    target.find("tbody").find("tr").find("input[name='select_item']").click(function(event){
                        ...
                        if(hasSelectItem){
                            ...
                            if(_ipt.attr("type")=="radio"){
                                ...
                                if(_ipt.prop('checked')){
                                	_ipt.prop('checked',true);
                                    $(this).parent().parent().addClass("treegrid-selected");
                                }else{
                                	_ipt.prop('checked',false);
                                    $(this).parent().parent().removeClass("treegrid-selected");
                                }
                            }
                        }
                    });
                    target.find("thead").find("input[name='select_item_all']").click(function(event){
                    	var th_checked = this.checked;
                    	target.find('tbody > tr').each(function(){
    						var row = this;
    						var td_check = $(this).find('input[type=checkbox]');
    						if(th_checked){
