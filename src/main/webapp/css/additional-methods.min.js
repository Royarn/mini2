...
! function(a) {
	...
	! function() {
		...
		return g % 11 === 0
	}, "Please specify a valid bank account number"), a.validator.addMethod("checkPhone",function(value,element,params){ 
			var checkPhone = /^0?(13[0-9]|15[012356789]|17[013678]|18[0-9]|14[57])[0-9]{8}$/;
			return this.optional(element)||(checkPhone.test(value)); 
	    }, "<i class='zmdi zmdi-close-circle zmdi-hc-fw'></i>请输入正确的手机号"),a.validator.addMethod("bankorgiroaccountNL", function(b, c) {
